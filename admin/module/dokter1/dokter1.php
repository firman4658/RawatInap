...
$aksi="module/dokter/aksi_dokter.php";
	...
	default:
		...
		echo"
		 <table cellpadding='5px' id='rawat' class='table table-striped jambo_table bulk_action table-bordered align-middle' cellspacing='0' width='120%'>
		 <thead>
			<tr>
				<th>NO</th> <th>Username</th> <th>Nama Lengkap</th> <th>Alamat</th> <th>Password</th> <th>Foto</th> <th>Spesialis</th> <th>Kontak</th>
			</tr></thead>";
			$no=0;
